...
let yourSentence = "There are many \(nounArray[2]) in the \(nounArray[6])"
let yourSillySentence = "Sometimes it hurts when a \(nounArray[index1]) comes by and hits you with a \(nounArray[index2])"
//: ### Exercise 2
...
let whisperString = "psst" + ", " + didYouKnowString.uppercaseString
let shoutString =  "HEY! DID YOU KNOW THAT THE SWIFT STRING CLASS COMES WITH LOTS OF USEFUL METHODS?"
let anWhisperString = "so" + "," + shoutString.lowercaseString
//: ### Exercise 3
//: How many characters are in this string? 
let howManyCharacters = "How much wood could a woodchuck chuck if a woodchuck could chuck wood?"
var sized = howManyCharacters.characters.count
//: ### Exercise 4
...
let noLike = lottaLikes.stringByReplacingOccurrencesOfString("like, ", withString: "")
//: ### Exercise 7
// Example
...
let numOfPennies = 12
//desired output = "$5.67"
print("\(numOfPennies) pennies is $\(numOfPennies / 100).\(numOfPennies%100)")
//: # Let or Var?
import UIKit
import Foundation
//: ### Exercise 9
