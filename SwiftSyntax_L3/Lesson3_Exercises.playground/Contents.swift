...
//Create an array with the arr initializer 
var booArr = [Bool](count: 5, repeatedValue: false)
...
admitted.append(waitingList.removeAtIndex(0))
print("Those who have been admitted now include \(admitted)")
//: ### Exercise 7
...
presidentialDogs["Bill Clinton"] = "Socks"
//: ### Exercise 12
